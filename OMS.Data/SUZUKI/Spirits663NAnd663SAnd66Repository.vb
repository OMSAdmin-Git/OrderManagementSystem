...
#End Region
        ...
        Public Function InsertRange(conn As OracleConnection, tran As OracleTransaction, records As List(Of Spirits663NAnd663SAnd66Row)) As String
            ...
            Try
                ...
                sb.AppendLine($"INSERT INTO SUZUKI_SPIRITS_663NAND663SAND66 (")
                ...
                Using cmd As New OracleCommand(sb.ToString(), conn)
                    ...
                    For Each r In records
                        ...
                        cmd.Parameters.Add(":p_old_delivery_date", OracleDbType.Date).Value = r.OldDeliveryDate
                        cmd.Parameters.Add(":p_delivery_date", OracleDbType.Date).Value = r.DeliveryDate

                        cmd.Parameters.Add(":p_old_order_qty", OracleDbType.Int64).Value = r.OldOrderQty

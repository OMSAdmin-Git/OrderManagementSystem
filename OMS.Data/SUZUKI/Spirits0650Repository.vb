...
Namespace OMS.Data.SUZUKI
    Public Class Spirits0650Repository
...
#End Region
        ''' <summary>
        ''' Spirits0650Row class をDBに追加する
        ''' </summary>
        ''' <param name="conn"></param>
        ''' <param name="tran"></param>
        ''' <param name="row"></param>
        ''' <returns>string: Number:xxxx Errormessage</returns>
        Public Function Insert(conn As OracleConnection, tran As OracleTransaction, row As Spirits0650Row) As String

            Dim records = New List(Of Spirits0650Row)()
            records.Add(row)
        ...
        ''' <summary>
        ''' Spirits0650Row class リストをDBに追加する (元のコード同等呼び出し
        ''' </summary>
        ''' <param name="records"></param>
        Public Sub InsertRange(records As IEnumerable(Of Spirits0650Row))
        ...
        End Sub
        ''' <summary>
        ''' Spirits0650Row record 追加
        ''' </summary>
        ''' <param name="conn"></param>
        ''' <param name="tran"></param>
        ''' <param name="records"></param>
        ''' <returns>string: Number:xxxx Errormessage</returns>
        Public Function InsertRange(conn As OracleConnection, tran As OracleTransaction, records As List(Of Spirits0650Row)) As String
            Dim errorMessage As String = ""
            If records Is Nothing Then Return "Spirits0650Row InsertRange no record data."
            Try
                Dim sb As New StringBuilder()
                sb.AppendLine($"INSERT INTO SUZUKI_SPIRITS_0650 (")
                ...
                sb.AppendLine("  process_process_no, reserve, customer_order_no, customer_order_no_process_no1, customer_order_no_process_no2, ")
                ...
                sb.AppendLine(" :p_process_process_no, :p_reserve, :p_customer_order_no, :p_customer_order_no_process_no1, :p_customer_order_no_process_no2, ")
                ...
                Using cmd As New OracleCommand(sb.ToString(), conn)
                    ...
                    For Each r In records
                        ...
                        cmd.Parameters.Add(":p_process_process_no", OracleDbType.Varchar2, 3).Value = SafeVarchar(r.ProcessProcessNo, 3)
                        cmd.Parameters.Add(":p_reserve", OracleDbType.Varchar2, 2).Value = SafeVarchar(r.Reserve, 2)
    ...
    Public Class Spirits0650Row
        ...
        Public Property ProcessProcessNo As String              ' 工程識別コード		VARCHAR2	3 CHAR
        Public Property Reserve As String                       ' 予備					VARCHAR2	2 CHAR

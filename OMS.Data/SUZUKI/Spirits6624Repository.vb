            ...
            Try
                ...
                Using cmd As New OracleCommand(sb.ToString(), conn)
                    ...
                    For Each r In records
                        ...
                        cmd.Parameters.Add(":p_direct_delivery_type", OracleDbType.Varchar2, 5).Value = SafeVarchar(r.DeliveryType, 5)
                        ...
                        cmd.Parameters.Add(":p_ship_instructions_date", OracleDbType.Date).Value = r.ShipInstructionsDate

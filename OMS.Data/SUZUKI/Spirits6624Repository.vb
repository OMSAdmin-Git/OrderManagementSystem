            ...
            Try
                ...
                Using cmd As New OracleCommand(sb.ToString(), conn)
                    ...
                    For Each r In records
                        ...
                        cmd.Parameters.Add(":p_delivery_location", OracleDbType.Varchar2, 8).Value = SafeVarchar(r.DeliveryLocation, 8)
                        ...
                        cmd.Parameters.Add(":p_customer_order_no_process_no1", OracleDbType.Varchar2, 7).Value = SafeVarchar(r.CustomerOrderNoProcessNo1, 7)
                        cmd.Parameters.Add(":p_customer_order_no_process_no2", OracleDbType.Varchar2, 12).Value = SafeVarchar(r.CustomerOrderNoProcessNo2, 12)
                        ...
                        cmd.Parameters.Add(":p_order_notes", OracleDbType.Varchar2, 30).Value = SafeVarcharLength(r.OrderNotes, 30)

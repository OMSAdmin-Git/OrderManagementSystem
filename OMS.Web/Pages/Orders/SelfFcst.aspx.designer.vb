...
Namespace Pages.Orders
    ...
    Partial Public Class SelfFcst
        ...
        '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
        '''</remarks>
        Protected WithEvents gvSelfFcst As Global.System.Web.UI.WebControls.GridView

        '''<summary>
        '''btnSelfFcstDelete コントロール。
        '''</summary>
        '''<remarks>
        '''自動生成されたフィールド。
        '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
        '''</remarks>
        Protected WithEvents btnSelfFcstDelete As Global.System.Web.UI.WebControls.Button

...
Namespace Pages.Orders
    ...
    Partial Public Class OrderExport
        ...
        '''<summary>
        '''btnOrderExport コントロール。
        '''</summary>
        '''<remarks>
        '''自動生成されたフィールド。
        '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
        '''</remarks>
        Protected WithEvents btnOrderExport As Global.System.Web.UI.WebControls.Button

        '''<summary>
        '''btnExportErrorList コントロール。
        '''</summary>
        '''<remarks>
        '''自動生成されたフィールド。
        '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
        '''</remarks>
        Protected WithEvents btnExportErrorList As Global.System.Web.UI.WebControls.Button

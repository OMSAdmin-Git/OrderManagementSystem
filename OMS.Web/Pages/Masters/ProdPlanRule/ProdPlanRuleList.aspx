<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ProdPlanRuleList.aspx.vb" Inherits="OMS.Web.Pages.Masters.ProdPlanRule.ProdPlanRuleList" MaintainScrollPositionOnPostback="true" %>
        ...
        <div class="process-container">
            ...
            <div class="data-list">
                <div class="data-grid-wrapper">
                    <asp:GridView ID="gvProdPlanRuleList" runat="server"
                        AutoGenerateColumns="False"
                        CssClass="data-grid"
                        BackColor="White"
                        BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px"
                        CellPadding="4" ForeColor="Black" GridLines="Both"
                        DataKeyNames="ProdPlanRuleId">
                        <Columns>
                            <asp:BoundField DataField="ProdPlanRuleId" HeaderText="生産計画条件ID" Visible="false" />
                            ...
                            <asp:TemplateField HeaderText="詳細">
                                <ItemTemplate>
                                    <asp:HyperLink ID="hlOpenSetting" runat="server"
                                        Text="開く"
                                        NavigateUrl='<%# "ProdPlanRuleSetting.aspx?id1=" & System.Web.HttpUtility.UrlEncode(Eval("ProdPlanRuleId").ToString()) %>'
                                        Target="_blank" />
                                </ItemTemplate>
                ...
                <!-- アクションボタン -->
                <div class="action-buttons">
                    <asp:Button ID="btnProdPlanRuleSettingCreate" runat="server" CssClass="btn-asti btn-asti-process" Text="新規登録" OnClick="btnProdPlanRuleSettingCreate_Click" />
                </div>

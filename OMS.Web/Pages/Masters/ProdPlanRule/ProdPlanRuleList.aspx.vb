Imports OMS.Common
Imports OMS.Data
Imports OMS.Web.Pages.Masters.ImpRule
Imports System.Data
Imports System.Text

Namespace Pages.Masters.ProdPlanRule
    Public Class ProdPlanRuleList
...
#Region "ページ ライフサイクル"
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            If Not IsPostBack Then
                ...
                ' 初期表示
                BindProdPlanRuleListGrid(activeFlag:="Y")
            End If
        End Sub
#End Region
...
#Region "GridView バインド"
        ' 用途ベース命名：ProdPlanRule 一覧グリッドにデータを流し込む
        Private Sub BindProdPlanRuleListGrid(
            ...
            gvProdPlanRuleList.DataSource = dt
            gvProdPlanRuleList.DataBind()
        End Sub
#End Region
...
#Region "画面遷移"
        ...
        ' 新規登録
        Protected Sub btnProdPlanRuleSettingCreate_Click(sender As Object, e As EventArgs)
            Response.Redirect("ProdPlanRuleSettingCreate.aspx")
        End Sub
#End Region

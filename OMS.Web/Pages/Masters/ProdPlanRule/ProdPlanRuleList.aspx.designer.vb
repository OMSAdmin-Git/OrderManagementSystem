...
Namespace Pages.Masters.ProdPlanRule
    ...
    Partial Public Class ProdPlanRuleList
        ...
        '''<summary>
        '''gvProdPlanRuleList コントロール。
        '''</summary>
        '''<remarks>
        '''自動生成されたフィールド。
        '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
        '''</remarks>
        Protected WithEvents gvProdPlanRuleList As Global.System.Web.UI.WebControls.GridView

        '''<summary>
        '''btnProdPlanRuleSettingCreate コントロール。
        '''</summary>
        '''<remarks>
        '''自動生成されたフィールド。
        '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
        '''</remarks>
        Protected WithEvents btnProdPlanRuleSettingCreate As Global.System.Web.UI.WebControls.Button
    End Class
End Namespace

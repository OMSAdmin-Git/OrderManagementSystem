<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ProdPlanRuleSetting.aspx.vb" Inherits="OMS.Web.Pages.Masters.ProdPlanRule.ProdPlanRuleSetting" %>
    ...
    <form id="form1" runat="server" novalidate="novalidate">
        <div class="process-container">
            ...
            <div class="action-buttons">
                <asp:Button ID="btnSaveProdPlanRuleSetting" runat="server"
                    CssClass="btn-asti btn-asti-process"
                    Text="保存"
                    OnClientClick="return validateRequiredFromBtn(this);"
                    OnClick="btnSaveProdPlanRuleSetting_Click" />
            </div>

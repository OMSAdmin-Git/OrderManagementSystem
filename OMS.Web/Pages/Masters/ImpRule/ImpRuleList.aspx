<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ImpRuleList.aspx.vb" Inherits="OMS.Web.Pages.Masters.ImpRule.ImpRuleList" MaintainScrollPositionOnPostback="true" %>
        ...
        <div class="process-container">
            ...
            <div class="data-list">
                <div class="data-grid-wrapper">
                    <asp:GridView ID="gvImpRuleList" runat="server"
                        AutoGenerateColumns="False"
                        CssClass="data-grid"
                        BackColor="White"
                        BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px"
                        CellPadding="4" ForeColor="Black" GridLines="Both"
                        DataKeyNames="ImpRuleId">
                        <Columns>
                            <asp:BoundField DataField="ImpRuleId" HeaderText="取込条件ID" Visible="false" />
                            ...
                            <asp:TemplateField HeaderText="詳細">
                                <ItemTemplate>
                                    <asp:HyperLink ID="hlOpenSetting" runat="server"
                                        Text="開く"
                                        NavigateUrl='<%# "ImpRuleSetting.aspx?id1=" & System.Web.HttpUtility.UrlEncode(Eval("ImpRuleId").ToString()) %>'
                                        Target="_blank" />
                                </ItemTemplate>
                ...
                <!-- アクションボタン -->
                <div class="action-buttons">
                    <asp:Button ID="btnImpRuleSettingCreate" runat="server" CssClass="btn-asti btn-asti-process" Text="新規登録" OnClick="btnImpRuleSettingCreate_Click" />
                </div>

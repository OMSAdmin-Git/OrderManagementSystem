...
#Region "ページ ライフサイクル"
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            If Not IsPostBack Then
                ...
                ' 初期表示
                BindImpRuleListGrid(activeFlag:="Y")
            End If
        End Sub
#End Region
...
#Region "GridView バインド"
        ' 用途ベース命名：ImpRule 一覧グリッドにデータを流し込む
        Private Sub BindImpRuleListGrid(
            ...
            gvImpRuleList.DataSource = dt
            gvImpRuleList.DataBind()
        End Sub
#End Region
...
#Region "画面遷移"
        ...
        ' 新規登録
        Protected Sub btnImpRuleSettingCreate_Click(sender As Object, e As EventArgs)
            Response.Redirect("ImpRuleSettingCreate.aspx")
        End Sub
#End Region

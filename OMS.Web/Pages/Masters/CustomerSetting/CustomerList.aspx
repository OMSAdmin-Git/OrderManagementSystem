<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CustomerList.aspx.vb" Inherits="OMS.Web.Pages.Masters.CustomerSetting.CustomerList" MaintainScrollPositionOnPostback="true" %>
            ...
            <div class="data-list">
                <div class="data-grid-wrapper">
                    <asp:GridView ID="gvCustomerList" runat="server"
                        ...
                        DataKeyNames="CustomerSettingId">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="詳細">
                                <ItemTemplate>
                                    <asp:HyperLink ID="hlOpenSetting" runat="server"
                                        Text="開く"
                                        NavigateUrl='<%# "CustomerSetting.aspx?id1=" & System.Web.HttpUtility.UrlEncode(Eval("CustomerSettingId").ToString()) %>'
                                        Target="_blank" />
                                </ItemTemplate>
                ...
                <!-- アクションボタン -->
                <div class="action-buttons">
                    <asp:Button ID="btnCustomerSettingCreate" runat="server" CssClass="btn-asti btn-asti-process" Text="新規登録" OnClick="btnCustomerSettingCreate_Click" />
                </div>

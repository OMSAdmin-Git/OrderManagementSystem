...
#Region "ページ ライフサイクル"
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            If Not IsPostBack Then
                ...
                ' 初期表示
                BindCustomerListGrid(activeFlag:="Y")
            End If
        End Sub
#End Region
...
#Region "GridView バインド"
        ' 用途ベース命名：Customer 一覧のグリッドにデータを流し込む
        Private Sub BindCustomerListGrid(
...
#Region "画面遷移"
        ...
        ' 新規登録
        Protected Sub btnCustomerSettingCreate_Click(sender As Object, e As EventArgs)
            Response.Redirect("CustomerSettingCreate.aspx")
        End Sub
#End Region

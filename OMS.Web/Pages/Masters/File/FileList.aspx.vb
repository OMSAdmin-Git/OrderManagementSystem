...
#Region "GridView バインド"
        ' 用途ベース命名：File 一覧グリッドにデータを流し込む
        Private Sub BindFileListGrid(
...
#Region "画面遷移"
        ...
        ' 新規登録
        Protected Sub btnFileSettingCreate_Click(sender As Object, e As EventArgs)
            Response.Redirect("FileSettingCreate.aspx")
        End Sub
#End Region

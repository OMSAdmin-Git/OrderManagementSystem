<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FileList.aspx.vb" Inherits="OMS.Web.Pages.Masters.File.FileList" MaintainScrollPositionOnPostback="true" %>
            ...
            <div class="data-list">
                <div class="data-grid-wrapper">
                    <asp:GridView ID="gvFileList" runat="server"
                        ...
                        DataKeyNames="FileId">
                        <Columns>
                            <asp:BoundField DataField="FileId" HeaderText="ファイルID" Visible="false" />
                            ...
                            <asp:TemplateField HeaderText="詳細">
                                <ItemTemplate>
                                    <asp:HyperLink ID="hlOpenSetting" runat="server"
                                        Text="開く"
                                        NavigateUrl='<%# "FileSetting.aspx?id1=" & System.Web.HttpUtility.UrlEncode(Eval("FileId").ToString()) %>'
                                        Target="_blank" />
                                </ItemTemplate>
                ...
                <!-- アクションボタン -->
                <div class="action-buttons">
                    <asp:Button ID="btnFileSettingCreate" runat="server" CssClass="btn-asti btn-asti-process" Text="新規登録" OnClick="btnFileSettingCreate_Click" />
                </div>

<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MappingSetting.aspx.vb" Inherits="OMS.Web.Pages.Masters.Mapping.MappingSetting" %>
    ...
    <form id="form1" runat="server" novalidate="novalidate">
        <div class="process-container">
            ...
            <div>
                ...
                <asp:ScriptManager ID="smCustomerName" runat="server" EnablePageMethods="true" />
            </div>
            <div>
            ...
            <div class="action-buttons">
                <asp:Button ID="btnSaveMappingSetting" runat="server"
                    CssClass="btn-asti btn-asti-process"
                    Text="保存"
                    OnClientClick="return validateRequiredFromBtn(this);"
                    OnClick="btnSaveMappingSetting_Click" />
            </div>

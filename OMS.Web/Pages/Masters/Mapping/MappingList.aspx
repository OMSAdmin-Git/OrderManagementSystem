<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MappingList.aspx.vb" Inherits="OMS.Web.Pages.Masters.Mapping.MappingList" MaintainScrollPositionOnPostback="true" %>
        ...
        <div class="process-container">
            ...
            <div class="data-list">
                <div class="data-grid-wrapper">
                    <asp:GridView ID="gvMappingList" runat="server"
                        ...
                        <Columns>
                            <asp:BoundField DataField="ProfileId" HeaderText="マッピングプロファイルID" Visible="false" />
                            ...
                            <asp:TemplateField HeaderText="詳細">
                                <ItemTemplate>
                                    <asp:HyperLink ID="hlOpenSetting" runat="server"
                                        Text="開く"
                                        NavigateUrl='<%# "MappingSetting.aspx?id1=" & Server.UrlEncode(Eval("ProfileId").ToString()) %>'
                                        Target="_blank" />
                                </ItemTemplate>
                ...
                <!-- アクションボタン -->
                <div class="action-buttons">
                    <asp:Button ID="btnMappingSettingCreate" runat="server" CssClass="btn-asti btn-asti-process" Text="新規登録" OnClick="btnMappingSettingCreate_Click" />
                </div>

...
Namespace Pages.Masters.Mapping
    ...
    Partial Public Class MappingList
        ...
        '''<summary>
        '''gvMappingList コントロール。
        '''</summary>
        '''<remarks>
        '''自動生成されたフィールド。
        '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
        '''</remarks>
        Protected WithEvents gvMappingList As Global.System.Web.UI.WebControls.GridView

        '''<summary>
        '''btnMappingSettingCreate コントロール。
        '''</summary>
        '''<remarks>
        '''自動生成されたフィールド。
        '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
        '''</remarks>
        Protected WithEvents btnMappingSettingCreate As Global.System.Web.UI.WebControls.Button
    End Class
End Namespace

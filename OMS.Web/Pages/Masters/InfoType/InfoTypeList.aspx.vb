...
#Region "ページ ライフサイクル"
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            If Not IsPostBack Then
                ...
                ' 初期表示
                BindInfoTypeListGrid(activeFlag:="Y")
            End If
        End Sub
#End Region
...
#Region "GridView バインド"
        ' 用途ベース命名：InfoType 一覧グリッドにデータを流し込む
        Private Sub BindInfoTypeListGrid(
            ...
            gvInfoTypeList.DataSource = dt
            gvInfoTypeList.DataBind()
        End Sub
#End Region
...
#Region "画面遷移"
        ...
        ' 新規登録
        Protected Sub btnInfoTypeSettingCreate_Click(sender As Object, e As EventArgs)
            Response.Redirect("InfoTypeSettingCreate.aspx")
        End Sub
#End Region

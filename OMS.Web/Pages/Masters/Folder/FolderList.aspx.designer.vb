...
Namespace Pages.Masters.Folder
    ...
    Partial Public Class FolderList
        ...
        '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
        '''</remarks>
        Protected WithEvents gvFolderList As Global.System.Web.UI.WebControls.GridView

        '''<summary>
        '''btnFolderSettingCreate コントロール。
        '''</summary>
        '''<remarks>
        '''自動生成されたフィールド。
        '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
        '''</remarks>
        Protected WithEvents btnFolderSettingCreate As Global.System.Web.UI.WebControls.Button
    End Class
End Namespace

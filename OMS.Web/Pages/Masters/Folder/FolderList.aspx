<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FolderList.aspx.vb" Inherits="OMS.Web.Pages.Masters.Folder.FolderList" MaintainScrollPositionOnPostback="true" %>
        ...
        <div class="process-container">
            ...
            <div class="data-list">
                <div class="data-grid-wrapper">
                    <asp:GridView ID="gvFolderList" runat="server"
                        AutoGenerateColumns="False"
                        CssClass="data-grid"
                        BackColor="White"
                        BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px"
                        CellPadding="4" ForeColor="Black" GridLines="Both"
                        DataKeyNames="FolderId, CustomerSettingId">
                        <Columns>
                            <asp:BoundField DataField="FolderId" HeaderText="フォルダID" Visible="false" />
                            ...
                            <asp:TemplateField HeaderText="詳細">
                                <ItemTemplate>
                                    <asp:HyperLink ID="hlOpenSetting" runat="server"
                                        Text="開く"
                                        NavigateUrl='<%# "FolderSetting.aspx?id1=" & System.Web.HttpUtility.UrlEncode(Eval("FolderId").ToString()) %>'
                                    Target="_blank" />
                                </ItemTemplate>
                ...
                <!-- アクションボタン -->
                <div class="action-buttons">
                    <asp:Button ID="btnFolderSettingCreate" runat="server" CssClass="btn-asti btn-asti-process" Text="新規登録" OnClick="btnFolderSettingCreate_Click" />
                </div>
